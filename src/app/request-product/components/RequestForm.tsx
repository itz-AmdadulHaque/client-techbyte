...
import { productRequestSchema, ProductRequestType } from '@/validators/productRequest.validation';
...
export default function ProductRequestForm() {
  ...
  const addCartMutation = useMutation({
    mutationFn: (data: z.infer<typeof productRequestSchema>) => onSubmit(data, 'add-to-cart'),
    onSuccess: (data) => {
  ...
  const orderNowMutation = useMutation({
    mutationFn: (data: z.infer<typeof productRequestSchema>) => onSubmit(data, 'order-now'),
    onSuccess: (data) => {
      toast.success(data.data.message, { position: 'top-center' })
      form.reset();
    }
